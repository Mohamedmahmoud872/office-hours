...
<div class="container">
    <h1 class="page_title">Send Message</h1>
    <div class="row">
        <div class="col-md-6 center_div">
            <form action="SendStaffMessageServlet" method="post">
                <input type="text" class="form-control" placeholder="Message Title" name="title" required>
                <textarea class="form-control mt-2" name="message" placeholder="Enter Message" required></textarea>
                <input type="hidden" name="to" value="<%=request.getParameter("to_ID")%>">
