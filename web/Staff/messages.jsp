...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 center_div">
            <form action="messageOne.jsp" class="mb-2" style="display: inline;margin-right: 5px;" method="post">
                <input type="submit" value="New Message" class="btn btn-primary">
            </form>
            <form action="selectSublect.jsp" class="mb-2" style="display: inline;" method="post">
                <input type="submit" value="Message Team" class="btn btn-success">
            </form>
