...
<div class="container">
    <h1 class="page_title">Meeting Reservation</h1>
    <div class="row">
        <div class="col-md-6 center_div">
            <form action="MeetingReservation" method="post">
                <h3 class="text-center">Meeting Date</h3>
                <input type="date" class="form-control" name="date">
                <input type="hidden" name="slot_id" value="<%=request.getParameter("slot_id")%>">
